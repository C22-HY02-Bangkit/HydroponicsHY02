...
import com.capstone.hidroponichy02.databinding.ActivityWelcomeBinding
...
class WelcomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnContinue.setOnClickListener {
            val moveToListDeviceActivity = Intent(this@WelcomeActivity, MainActivity::class.java)
            moveToListDeviceActivity.putExtra(MainActivity.EXTRA_USER, user)
