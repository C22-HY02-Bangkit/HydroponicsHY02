...
import com.capstone.hidroponichy02.databinding.ActivityMlTomatBinding
...
class MlTomatActivity : AppCompatActivity() {
    private lateinit var binding : ActivityMlTomatBinding
    var imageSize = 150
    companion object {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMlTomatBinding.inflate(layoutInflater)
